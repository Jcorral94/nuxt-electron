          ...
          <div class="overflow-x-auto shadow-md sm:rounded-lg">
            <div class="inline-block max-h-80 h-full align-center">
              <div class="overflow-hidden">
                <table id="proship-table" v-if="state.data.length > 0"
                  ...
                  <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    <tr v-for="row in state.data" class="hover:bg-light dark:hover:bg-light bg-white">
                      <td class="py-1 px-1 text-sm font-small text-gray-900 whitespace-nowrap dark:text-gray">
                        {{ row.tracking_number }}
                      </td>
                      <td class="py-1 px-1 text-sm font-small text-gray-900 whitespace-nowrap dark:text-gray">
